...
import RealisticClouds from './components/RealisticClouds'; // Add this import
import './App.css';
...
function App() {
  ...
  return (
    <div className="App">
      <PlasmaBackground />
	{!activeDay && <RealisticClouds />} {/* Only show when modal is closed */}
      <div className="app-root">
        ...
        <main className="island-wrapper">
          ...
          <div className="island-plate">
            {/* Remove or comment out the old clouds div */}
